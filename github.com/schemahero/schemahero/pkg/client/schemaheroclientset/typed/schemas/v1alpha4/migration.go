...
type MigrationInterface interface {
	Create(*v1alpha4.Migration) (*v1alpha4.Migration, error)
	Update(*v1alpha4.Migration) (*v1alpha4.Migration, error)
	UpdateStatus(*v1alpha4.Migration) (*v1alpha4.Migration, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha4.Migration, error)
	List(opts v1.ListOptions) (*v1alpha4.MigrationList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha4.Migration, err error)
	MigrationExpansion
}
...
func (c *migrations) Get(name string, options v1.GetOptions) (result *v1alpha4.Migration, err error) {
...
func (c *migrations) List(opts v1.ListOptions) (result *v1alpha4.MigrationList, err error) {
...
func (c *migrations) Create(migration *v1alpha4.Migration) (result *v1alpha4.Migration, err error) {
	result = &v1alpha4.Migration{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("migrations").
...
func (c *migrations) Update(migration *v1alpha4.Migration) (result *v1alpha4.Migration, err error) {
	result = &v1alpha4.Migration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("migrations").
...
func (c *migrations) UpdateStatus(migration *v1alpha4.Migration) (result *v1alpha4.Migration, err error) {
	result = &v1alpha4.Migration{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("migrations").
...
func (c *migrations) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha4.Migration, err error) {
	result = &v1alpha4.Migration{}
