...
type TableInterface interface {
	Create(*v1alpha4.Table) (*v1alpha4.Table, error)
	Update(*v1alpha4.Table) (*v1alpha4.Table, error)
	UpdateStatus(*v1alpha4.Table) (*v1alpha4.Table, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha4.Table, error)
	List(opts v1.ListOptions) (*v1alpha4.TableList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha4.Table, err error)
	TableExpansion
}
...
func (c *tables) Get(name string, options v1.GetOptions) (result *v1alpha4.Table, err error) {
...
func (c *tables) List(opts v1.ListOptions) (result *v1alpha4.TableList, err error) {
...
func (c *tables) Create(table *v1alpha4.Table) (result *v1alpha4.Table, err error) {
	result = &v1alpha4.Table{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tables").
...
func (c *tables) Update(table *v1alpha4.Table) (result *v1alpha4.Table, err error) {
	result = &v1alpha4.Table{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tables").
...
func (c *tables) UpdateStatus(table *v1alpha4.Table) (result *v1alpha4.Table, err error) {
	result = &v1alpha4.Table{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tables").
...
func (c *tables) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha4.Table, err error) {
	result = &v1alpha4.Table{}
