...
func (c *FakeTables) Get(name string, options v1.GetOptions) (result *v1alpha4.Table, err error) {
	obj, err := c.Fake.
...
func (c *FakeTables) List(opts v1.ListOptions) (result *v1alpha4.TableList, err error) {
	obj, err := c.Fake.
...
func (c *FakeTables) Create(table *v1alpha4.Table) (result *v1alpha4.Table, err error) {
	obj, err := c.Fake.
...
func (c *FakeTables) Update(table *v1alpha4.Table) (result *v1alpha4.Table, err error) {
	obj, err := c.Fake.
...
func (c *FakeTables) UpdateStatus(table *v1alpha4.Table) (*v1alpha4.Table, error) {
	obj, err := c.Fake.
...
func (c *FakeTables) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha4.Table, err error) {
	obj, err := c.Fake.
