...
func (c *FakeDatabases) Get(name string, options v1.GetOptions) (result *v1alpha4.Database, err error) {
	obj, err := c.Fake.
...
func (c *FakeDatabases) List(opts v1.ListOptions) (result *v1alpha4.DatabaseList, err error) {
	obj, err := c.Fake.
...
func (c *FakeDatabases) Create(database *v1alpha4.Database) (result *v1alpha4.Database, err error) {
	obj, err := c.Fake.
...
func (c *FakeDatabases) Update(database *v1alpha4.Database) (result *v1alpha4.Database, err error) {
	obj, err := c.Fake.
...
func (c *FakeDatabases) UpdateStatus(database *v1alpha4.Database) (*v1alpha4.Database, error) {
	obj, err := c.Fake.
...
func (c *FakeDatabases) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha4.Database, err error) {
	obj, err := c.Fake.
